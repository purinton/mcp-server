 ...
 * into the extra context passed to MCP tool handlers (CommonJS version).
 */
class BearerStreamableHTTPServerTransport extends StreamableHTTPServerTransport {
...
module.exports = { BearerStreamableHTTPServerTransport };
